...
document.addEventListener("DOMContentLoaded", function(event) {
  // Menu
  document.getElementById('nav-trigger').addEventListener('change', function(event) {
  ...
  // PhotoSwipe
  var pswpElement = document.querySelectorAll('.pswp') && document.querySelectorAll('.pswp')[0]
